  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Transação</li>
        <li class="active">Pedir emprestado</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Pedir emprestado</a>
            </div>
            <div class="box-body">
                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      if($row['barstat']){
                        $status = '<span class="label label-success">retornou</span>';
                      }
                      else{
                        $status = '<span class="label label-danger">não devolvido</span>';
                      }
                      echo "
                        <tr>
                          <td class='hidden'></td>
