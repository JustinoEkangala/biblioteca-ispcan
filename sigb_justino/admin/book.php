                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      if($row['status']){
                        $status = '<span class="label label-danger">emprestado</span>';
                      }
                      else{
                        $status = '<span class="label label-success">acessível</span>';
                      }
                      echo "
                        <tr>
                          <td>".$row['name']."</td>
                          ...
                          <td>
                            ...
                            <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['bookid']."'><i class='fa fa-trash'></i> Excluir</button>
                          </td>
                        </tr>
                      ";
                    }
