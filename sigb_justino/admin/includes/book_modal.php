    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Adicionar novo livro</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">Data de publicação</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Editar livro</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="datepicker_edit" class="col-sm-3 control-label">Data de publicação</label>
